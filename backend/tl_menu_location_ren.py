## =============================================================================
## CHRONOLOGY MOD — tl_menu_location_ren.py
...
if TYPE_CHECKING:
    ...
    from tl_assets_ren import _tl_stmt_ast_key  # type-check-only; injected into store namespace at runtime
...
def _tl_normalize_script_path(path):  # type: (Any) -> Any
...
def _tl_menu_site_key(file_path, line_no):  # type: (Optional[str], Optional[int]) -> Optional[tuple]
...
def _tl_location_menu_ast_key(location):  # type: (Any) -> Optional[tuple]
...
def _tl_location_menu_site_key(location):  # type: (Any) -> Optional[tuple]
...
def _tl_node_menu_site_key(node):  # type: (Any) -> Optional[tuple]
...
def _tl_live_menu_lookup():  # type: () -> dict
