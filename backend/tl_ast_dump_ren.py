## =============================================================================
## CHRONOLOGY MOD — tl_ast_dump_ren.py
...
if TYPE_CHECKING:
    ...
    from timeline_init_ren import _tl_log, _tl_json  # type-check-only; injected into store namespace at runtime

"""renpy
init -2 python:
"""

def _tl_cfg_dump_ast(labels=None, outfile=None):  # type: (Optional[List[str]], Optional[str]) -> None
    """
